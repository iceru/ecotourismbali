...
<title> Invoice Eco Tourism Bali </title>
                                ...
                                <tr>
                                    <td>
                                        <table width="150" border="0" cellpadding="0" cellspacing="0"
                                            align="left" class="col" style="text-align: left; float:left;">
                                            <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <img src="https://ecotourismbali.com/wp-content/uploads/2022/09/LOGO-1.png"
                                        ...
                                        <table width="220" border="0" cellpadding="0" cellspacing="0"
                                            align="right" class="col" style="text-align: right;">
                                            <tbody>
                                                <tr>
                                                    <td height="20" style="height: 20px"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table width="100%" " style="margin: auto; width: 100%!important;">
                                                            <tbody>
                                                                <tr>
                                                                    <td
                                                                        style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; vertical-align: top; text-align: right;">
                                                                        <span
                                                                            style="font-size: 21px; font-weight:bold; color: #1F656C;">Invoice</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td
                                                                        style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; vertical-align: top; text-align: right;">
                                                                        <b>Eco Tourism Bali</b>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td
                                                                        style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; vertical-align: top; text-align: right;">
                                                                        <span style="white-space: nowrap">Jl. Srirama
                                                                            Gg.
                                                                            Kayu Manis III
                                                                        </span>
                                                                    </td>
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <table width="190" border="0" cellpadding="0" cellspacing="0" style="text-align: left; margin-top: -16px; min-height:190px; float:left; box-sizing: border-box; padding-bottom: 16px">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <table width="100%" style="width: 100%">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: left;">
                                                                         <b>{{ $payment->member->business_name }}</b>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: left;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="100%" style="width: 100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right; white-space:nowrap">
                                                                        <b>Invoice No:</b>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    <td>
                                                        <table style="margin-top: 16px">
                                                            <tbody>
                                                                <tr>
                                                                    <td  style="font-size: 12px; color: #5b5b5b; padding-left: 6px; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; white-space:nowrap">
                                                                        {{ $payment->status_code }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td  style="font-size: 12px; color: #5b5b5b; padding-left: 6px; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; white-space:nowrap">
                                                                        {{ $payment->created_at->addDays(7)->toFormattedDateString() }}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1F656C;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                            class="article">
                                            {!! $payment->invoice_item_text !!}
                                        </td>
                                        ...
                                        <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                            align="right">
                                            Rp{{ number_format($payment->member->total_payment, 0) }}</td>
                                    </tr>
                                    <tr>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="80"
                                            style="font-size: 12px; padding-left:4px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                                            <strong>Rp{{ number_format($payment->member->total_payment, 0) }}</strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
